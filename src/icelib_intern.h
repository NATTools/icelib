...
void
ICELIB_log_(const ICELIB_CALLBACK_LOG* pCallbackLog,
            ICELIB_logLevel            logLevel,
            const char*                function,
            const char*                file,
            unsigned int               line,
...
void
ICELIB_startAllStoppingTimers(ICELIB_INSTANCE* pInstance);
void
ICELIB_tickAllStoppingTimers(ICELIB_INSTANCE* pInstance);
...
bool
ICELIB_isTriggeredFifoPairPresent(ICELIB_TRIGGERED_FIFO* pFifo,
                                  ICELIB_LIST_PAIR*      pPair,
                                  ICELIB_CALLBACK_LOG*   pCallbackLog);

bool
ICELIB_triggeredFifoPutIfNotPresent(ICELIB_TRIGGERED_FIFO* pFifo,
                                    ICELIB_LIST_PAIR*      pPair,
                                    ICELIB_CALLBACK_LOG*   pCallbackLog);

void
ICELIB_triggeredFifoRemove(ICELIB_TRIGGERED_FIFO* pFifo,
                           ICELIB_LIST_PAIR*      pPair);
...
ICELIB_LIST_PAIR*
pICELIB_triggeredfifoIteratorNext(ICELIB_CHECKLIST*               pCheckList,
                                  ICELIB_CALLBACK_LOG*            pCallbackLog,
                                  ICELIB_TRIGGERED_FIFO_ITERATOR* pIterator);
